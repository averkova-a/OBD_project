...
* Система підстановки дозволяє скласти план роботи на день, тиждень, місяць, а також планувати свій чвс нв вирішення робочих завдань.  
* Имеется возможность отслеживать проблеми проекта и слідкувати за виконанням кожного завдання.  
...
- Великий функціонал.
- Надзвичайно висока чуйність додатку. Можливість керувати майже всіма функціями за допомогою клавіатури.(Майже всіма функціямиможна керувати за допомогою  
  клавіатури.)
...
- зручні дошки("що потрібно зробити", "что делается", "що зроблено") і чати;  
